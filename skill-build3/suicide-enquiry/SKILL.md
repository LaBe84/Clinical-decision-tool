...
What was directly asked vs inferred
...
- Treating "no current ideation reported" as equivalent to "no risk" — that's
  a formulation judgement, and even as a judgement it's one PORF has already
  been built to avoid making.
